...
class BertCLSModel(nn.Cell):
    ...
    def __init__(self, config, is_training, num_labels=3, dropout_prob=0.0, use_one_hot_embeddings=False,
                 assessment_method=""):
    ...
    def construct(self, input_ids, input_mask, token_type_id,retrun_sequence=False):
        if retrun_sequence==False:
